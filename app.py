...
def add_production_legend():
    """Add production legend to the side of the map"""
    legend_html = """
    <div style="position: fixed; 
                top: 10%; right: 5%; width: 250px; height: 120px;
        ...
        <i style="background-color: red; padding: 5px;"></i> Low Production<br>
        <p style="font-size: 12px; color: grey;">Countries with total production above the 75th percentile are considered <b>high production</b>, and those below the 25th percentile are considered <b>low production</b>.</p>
    </div>
    """
    return legend_html
